...
DEFINE_DEVICE_TYPE(UPD1771C_017, upd1771c_017_device, "upd1771c_017", "NEC uPD1771C 017")


upd1771c_017_device::upd1771c_017_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
	: device_t(mconfig, UPD1771C_017, tag, owner, clock)
...
void upd1771c_017_device::device_start()
{
	m_timer = timer_alloc(FUNC(upd1771c_017_device::ack_callback), this);
...
void upd1771c_017_device::device_reset()
{
	m_index = 0;
	m_expected_bytes = 0;
	m_pc3 = 0;
...
uint8_t upd1771c_017_device::read()
{
	return 0x80; // TODO
}
...
void upd1771c_017_device::write(uint8_t data)
{
...
void upd1771c_017_device::pcm_write(int state)
{
	//RESET upon HIGH
	if (state != m_pc3)
	{
...
TIMER_CALLBACK_MEMBER( upd1771c_017_device::ack_callback )
{
	m_ack_handler(1);
}
...
void upd1771c_017_device::sound_stream_update(sound_stream &stream, std::vector<read_stream_view> const &inputs, std::vector<write_stream_view> &outputs)
{
